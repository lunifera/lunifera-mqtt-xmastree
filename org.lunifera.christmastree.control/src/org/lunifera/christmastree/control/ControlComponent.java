...
public class ControlComponent extends CustomComponent implements MqttCallback {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		image.setWidth("100%");
		image.setValue("<div style=\"overflow:hidden; width: 400px; margin-left: -60px;\">"
				+ "<img src=\"http://luniferaoffice.dyndns.org:8081\"/>"
				+ "</div>");
	...
	private GridLayout buildPanel() {
		...
		// button_bighter
		button_brighter = new Embedded(null, new ThemeResource(
				"./images/brighter.png"));
		...
		// button_darker
		button_darker = new Embedded(null, new ThemeResource(
				"./images/darker.png"));
		...
		// button_green
		button_green = new Embedded(null, new ThemeResource(
				"./images/green.png"));
		...
		// button_white
		button_white = new Embedded(null, new ThemeResource(
				"./images/white.png"));
		...
		// button_darkorange
		button_darkorange = new Embedded(null, new ThemeResource(
				"./images/darkorange.png"));
		...
		// button_lightgreen
		button_lightgreen = new Embedded(null, new ThemeResource(
		...
		// button_lightblue
		button_lightblue = new Embedded(null, new ThemeResource(
		...
		// button_flash
		button_flash = new Embedded(null, new ThemeResource(
				"./images/flash.png"));
		...
		// button_orange
		button_orange = new Embedded(null, new ThemeResource(
				"./images/orange.png"));
		...
		// button_lightcyan
		button_lightcyan = new Embedded(null, new ThemeResource(
				"./images/lightcyan.png"));
		...
		// button_darkpurple
		button_darkpurple = new Embedded(null, new ThemeResource(
		...
		// button_strobe
		button_strobe = new Embedded(null, new ThemeResource(
				"./images/strobe.png"));
		...
		// button_lightorange
		button_lightorange = new Embedded(null, new ThemeResource(
				"./images/lightorange.png"));
		...
		// button_purple
		button_purple = new Embedded(null, new ThemeResource(
				"./images/purple.png"));
		...
		// button_yellow
		button_yellow = new Embedded(null, new ThemeResource(
				"./images/yellow.png"));
		...
		// button_darkcyan
		button_darkcyan = new Embedded(null, new ThemeResource(
				"./images/darkcyan.png"));
		...
		// button_lightpurple
		button_lightpurple = new Embedded(null, new ThemeResource(
		...
		// button_smooth
		button_smooth = new Embedded(null, new ThemeResource(
				"./images/smooth.png"));
		...
		panel.addComponent(button_star, 0, 6);
		panel.setComponentAlignment(button_star, new Alignment(48));

		// button_angel
		button_angel = new Embedded(null, new ThemeResource(
				"./images/angel.png"));
